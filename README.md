...
To build the project I used vanilla HTML, CSS and JS following [this guide](https://jams.hackclub.com/batch/webOS) which helped with laying the foundations for the project.

## How to Run Locally

1. Clone the repo:
    ```
    git clone https://github.com/n0kira/KittenOS.git
    ```
2. Open `index.html`
